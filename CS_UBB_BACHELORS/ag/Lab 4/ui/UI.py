...
class UI(object):
    ...
    def showOpt(self):
        ...
        print("14.Toposort DAG")
        print("15.Show earliest/latest activity start; show critical path")
        print("0.Exit")
    ...
    def isEdge(self):
        ...
        print("Input destination vertex: ")
        destinationVertex = int(input())
        print(self._controller.isEdge(startVertex, destinationVertex))
    ...
    def toposort(self):
        print(self._controller.topoSortPredCount())
    
    def activities(self):
        self._controller.activityTimes()
        print("Critical path: ",self._controller.criticalPath())
